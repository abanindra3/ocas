...
export default function ProductsPage() {
  ...
  const [products, setProducts] = useState<Product[]>([
    ...
    { id: 8, name: "Dosa", price: 50, stock: 40, isVeg: true, rating: 4.5, image: "dosa.webp" },
    { id: 9, name: "Veg Momos", price: 50, stock: 30, isVeg: true, rating: 4.75, image: "vmomos.webp" },
    { id: 10, name: "Chicken Momos", price: 60, stock: 30, isVeg: false, rating: 4.9, image: "nvmomos.webp" },
  ])
