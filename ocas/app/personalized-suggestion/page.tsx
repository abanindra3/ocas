...
const mockSuggestions: SuggestedItem[] = [
  { id: 1, name: "Spicy Tofu Bowl", price: 9.99, image: "/placeholder.svg?height=100&width=100", category: "Vegetarian", isNew: true },
  { id: 2, name: "Grilled Salmon Salad", price: 12.99, image: "/placeholder.svg?height=100&width=100", category: "Healthy", isNew: false },
  { id: 3, name: "Mushroom Risotto", price: 10.99, image: "/placeholder.svg?height=100&width=100", category: "Vegetarian", isNew: false },
  { id: 4, name: "BBQ Chicken Wrap", price: 8.99, image: "/placeholder.svg?height=100&width=100", category: "Lunch Special", isNew: true },
  { id: 5, name: "Mango Tango Smoothie", price: 5.99, image: "/placeholder.svg?height=100&width=100", category: "Beverages", isNew: false },
  { id: 6, name: "Quinoa Buddha Bowl", price: 11.99, image: "/placeholder.svg?height=100&width=100", category: "Vegan", isNew: true },
]
