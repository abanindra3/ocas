...
// const AdminDashboard: React.FC<AdminDashboardProps> = ({ products, setProducts, updateProductStock, setUserType }) => {
...
//   useEffect(() => {
//     // Simulating fetching orders, feedbacks, and suggestions
//     setOrders([
...
//             <TabsTrigger value="inventory" className="rounded-lg py-2.5 text-sm font-medium leading-5 text-gray-700 ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-400 focus:outline-none focus:ring-2 aria-selected:bg-white aria-selected:shadow">
//               <AiOutlineStar className="mr-2 inline-block" />
//               Inventory
//             </TabsTrigger>
//             <TabsTrigger value="add-product" className="rounded-lg py-2.5 text-sm font-medium leading-5 text-gray-700 ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-400 focus:outline-none focus:ring-2 aria-selected:bg-white aria-selected:shadow">
//               <AiOutlinePlus className="mr-2 inline-block" />
//               Add Product
//             </TabsTrigger>
//             <TabsTrigger value="orders" className="rounded-lg py-2.5 text-sm font-medium leading-5 text-gray-700 ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-400 focus:outline-none focus:ring-2 aria-selected:bg-white aria-selected:shadow">
//               <FaShoppingCart className="mr-2 inline-block" />
//               Orders
//             </TabsTrigger>
//             <TabsTrigger value="feedback" className="rounded-lg py-2.5 text-sm font-medium leading-5 text-gray-700 ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-400 focus:outline-none focus:ring-2 aria-selected:bg-white aria-selected:shadow">
//               <FaComments className="mr-2 inline-block" />
//               Feedback
//             </TabsTrigger>
//             <TabsTrigger value="suggestions" className="rounded-lg py-2.5 text-sm font-medium leading-5 text-gray-700 ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-400 focus:outline-none focus:ring-2 aria-selected:bg-white aria-selected:shadow">
...
//                 </div>
//                 <div className="space-y-2">
//                   <Label htmlFor="product-price" className="text-gray-700">Price</Label>
//                   <Input
//                     id="product-price"
...
//                 </div>
//                 <div className="space-y-2">
//                   <Label htmlFor="product-stock" className="text-gray-700">Initial Stock</Label>
//                   <Input
//                     id="product-stock"
...
//                     onCheckedChange={(checked:any) => setNewProduct({ ...newProduct, isVeg: checked })}
//                   />
//                   <Label htmlFor="product-veg" className="text-gray-700">Vegetarian</Label>
//                 </div>
//                 <div className="space-y-2">
//                   <Label htmlFor="product-image" className="text-gray-700">Product Image URL</Label>
//                   <Input
//                     id="product-image"
